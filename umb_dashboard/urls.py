...
urlpatterns = patterns('',
    #url(r'^umb/', include(patterns('', 
      ...
      url(r'^medactive/cohort_summary/login/$', 'django.contrib.auth.views.login', { 'template_name': 'medactive_login.html' }),
      url(r'^heart2haart/login/$', 'django.contrib.auth.views.login', { 'template_name': 'heart2haart_login.html' }),
      url(r'^heart2haart/cohort_summary/login/$', 'django.contrib.auth.views.login', { 'template_name': 'heart2haart_login.html' }),
      ...
      url(r'^medactive/participants/([^/]+)/clinician_alerts$', 'medactive.views.clinician_alerts'),
